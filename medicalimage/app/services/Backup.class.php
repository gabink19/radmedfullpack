...
class Backup
{
    ...
    public function backupDatabase() {
        ...
        $dumpSettings = array(
            'add-drop-table' => true,
            'no-data' => $this->skipDatabaseTableData,
        );

        // dump the database
        $dump = new IMysqldump\Mysqldump('mysql:host=' . _CONFIG_DB_HOST . ';dbname=' . _CONFIG_DB_NAME, _CONFIG_DB_USER, _CONFIG_DB_PASS, $dumpSettings);
