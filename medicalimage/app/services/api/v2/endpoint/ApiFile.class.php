...
class ApiFile extends ApiV2
{
    ...
    protected function upload() {
        ...
        // LogHelper::info('Uploadfiles: ' . json_encode($this->request));
        ...
        //     throw new \Exception('Filesize received was zero.'.json_encode($uploadedFile));
        // }
        ...
        if (isset($uploadedFile['tmp_name'])) {
            ...
            $post['files'] = curl_file_create($this->request['upload_file'], null, basename($this->request['upload_file']));
        }
