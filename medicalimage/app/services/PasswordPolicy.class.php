...
class PasswordPolicy
{
    ...
    function __construct($params = array()) {
        ...
        $this->rules['min_length'] = array(
            ...
            'error' => TranslateHelper::t('password_policy_password_must_be_more_than_characters', 'Password must be more than #VALUE# characters long'));

        $this->rules['max_length'] = array(
            'value' => false,
            'type' => 'integer',
            'test' => 'return (strlen($p)<=$v);',
            'error' => TranslateHelper::t('password_policy_password_must_be_less_than_characters', 'Password must be less than #VALUE# characters long'));
        ...
        $this->rules['min_uppercase_chars'] = array(
            ...
            'type' => 'integer',
            'test' => 'return preg_match_all("/[A-Z]/",$p,$x)>=$v;',
            'error' => TranslateHelper::t('password_policy_password_must_contact_uppercase_characters', 'Password must contain at least #VALUE# uppercase characters'));
        ...
        $this->rules['min_numeric_chars'] = array(
            ...
            'error' => TranslateHelper::t('password_policy_password_must_contain_min_numeric_characters', 'Password must contain at least #VALUE# numbers'));
        ...
        $this->rules['min_nonalphanumeric_chars'] = array(
            ...
            'error' => TranslateHelper::t('password_policy_password_must_contain_min_nonalphanumeric_characters', 'Password must contain at least #VALUE# non-aplhanumeric characters'));
