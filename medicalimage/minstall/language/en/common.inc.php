...
$arrLang['alert_remove_files'] = "<br/>For security reasons, please remove the entire <b>/install/</b> folder from your website. Please also set permissions on ../_config.inc.php back to CHMOD 644.";
...
$arrLang['error_check_db_connection'] = "Database connection error! Please check your connection parameters._ERROR_<br />";
...
$arrLang['admin_login_info'] = "Your username must be at least 4 characters long and case-sensitive. Please do not enter accented characters.";
...
$arrLang['click_start_button'] = "Click on the start button to begin the new installation";
...
$arrLang['file_successfully_created'] = "The _CONFIG_FILE_ file was successfully created, database imported and initial admin user set.";
$arrLang['follow_the_wizard'] = "Follow the Wizard to setup a <strong>New</strong> installation.";
$arrLang['installation_guide'] = "Installation Guide";
$arrLang['installation_type'] = "Installation Type";
$arrLang['language'] = "Language";
$arrLang['license'] = "Script License";
...
$arrLang['perform_manual_installation'] = "New <b>Manual</b> installation";
$arrLang['perform_upgrade_installation'] = "<b>Upgrade</b> from v2.x";
$arrLang['perform_upgrade_installation_prior_2'] = "<b>Upgrade</b> from v1.x";
$arrLang['php_version'] = "PHP Version";
$arrLang['proceed_to_login_page'] = "Proceed to the Script Homepage"; 
$arrLang['proceed_to_admin_page'] = "Admin Area"; 
...
$arrLang['step_1_database_import'] = "Database Import";
$arrLang['step_1_database_import_error'] = "Database Import (error)";
$arrLang['step_2_installation_completed'] = "Installation Completed!";
$arrLang['step_2_updating_completed'] = "Updating Completed!";
$arrLang['step_2_uninstallation_completed'] = "Uninstallation Completed!";
